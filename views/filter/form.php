<div class="at-rest-filter-form-wrapper form col-5">
    <form class="filters__form" data-search-type="<?php echo esc_attr($atts['post_type']); ?>">
        <div class="form-user__field">
            <input type="text" name="firstname" id="filter-firstname" placeholder="First name" class="form-user__input" value="<?php echo esc_attr($search->get('firstname', '')); ?>">
            <button type="button" class="form-user__reset-btn" id="reset_firstname" style="display: none;">×</button>
        </div>

        <div class="form-user__field">
            <input type="text" name="surname" id="filter-surname" placeholder="Surname" class="form-user__input" value="<?php echo esc_attr($search->get('surname', '')); ?>">
            <button type="button" class="form-user__reset-btn" id="reset_surname" style="display: none;">×</button>
        </div>

        <div class="form-user__field">
            <input type="text" name="nee" id="filter-nee" placeholder="Née" class="form-user__input" value="<?php echo esc_attr($search->get('nee', '')); ?>">
        ...
        <div class="form-user__field">
            ...
            <button type="button" class="form-user__reset-btn" id="reset_county" style="display: none;">×</button>
        </div>
        ...
        <div class="form-user__field">
            ...
            if ($selectedCounty && isset($counties_data[$selectedCounty])) : 
                foreach ($counties_data[$selectedCounty] as $town) : ?>
                    <option value="<?php echo esc_attr($town); ?>" <?php selected($search->get('town'), $town); ?>><?php echo esc_html($town); ?></option>
                <?php endforeach;
            endif; ?>
            </select>
            <button type="button" class="form-user__reset-btn" id="reset_town" style="display: none;">×</button>
        </div>

        <div class="form-user__field">
            <input type="text" name="from" id="filter-date-from" placeholder="From" class="form-user__input is--date" value="<?php echo esc_attr($search->get('from', '')); ?>">
            <button type="button" class="form-user__reset-btn" id="reset_from" style="display: none;">×</button>
        </div>

        <div class="form-user__field">
            <input type="text" name="to" id="filter-date-to" placeholder="To" class="form-user__input is--date" value="<?php echo esc_attr($search->get('to', '')); ?>">
            <button type="button" class="form-user__reset-btn" id="reset_to" style="display: none;">×</button>
        </div>
